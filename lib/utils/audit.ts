...
export async function logAccess(
  ...
  try {
    ...
    logger.error({ error, userId, path, role }, 'Failed to log access event');
  }
}
...
export async function logAuthentication(
  ...
  try {
    ...
    logger.error({ error, userId, action }, 'Failed to log authentication event');
  }
}
...
export async function logDataModification(
  ...
  try {
    ...
    logger.error({ error, userId, action, resourceType }, 'Failed to log data modification event');
  }
}
...
export async function logSystemEvent(
  ...
  try {
    ...
    logger.error({ error, action, resourceType }, 'Failed to log system event');
  }
}
