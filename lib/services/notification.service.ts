...
class NotificationService {
  ...
  async sendEmail(
    ...
    try {
      SimpleLogger.warn('Email service not configured - using Azure Communication Services instead');
      
      // TODO: Implement Azure Communication Services email
      ...
      await this.logNotification({
        ...
        status: 'pending',
        metadata: { note: 'Azure Communication Services not yet implemented' },
      });

      SimpleLogger.info('Email queued for Azure Communication Services', { to, subject });
      return true;
    } catch (error) {
