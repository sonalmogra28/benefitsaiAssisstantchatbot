...
export class AzureAuditLoggingService {
  ...
  private async initialize(): Promise<void> {
    ...
    try {
      ...
      logger.error({ error }, 'Failed to initialize Azure audit logging service');
  ...
  private async logToApplicationInsights(event: AuditEvent): Promise<void> {
    try {
      ...
      logger.error({ error, eventId: event.id }, 'Failed to log to Application Insights');
    }
  }
  ...
  private async logToLogAnalytics(event: AuditEvent): Promise<void> {
    try {
      ...
      logger.error({ error, eventId: event.id }, 'Failed to log to Log Analytics');
    }
  }
  ...
  private async sendToApplicationInsights(event: any): Promise<void> {
    try {
      ...
      logger.error({ error }, 'Failed to send to Application Insights');
    }
  }
  ...
  private async sendToLogAnalytics(event: LogAnalyticsEvent): Promise<void> {
    try {
      ...
      logger.error({ error }, 'Failed to send to Log Analytics');
    }
  }
