...
Write-Host "Cosmos Connection: AccountEndpoint=https://${prefix}-cosmos.documents.azure.com:443/;AccountKey=$($cosmosKeys.primaryMasterKey)"
...
Write-Host "Redis URL: rediss://:$($redisKeys.primaryKey)@${redisHost}:6380"
...
Write-Host "Storage Connection: DefaultEndpointsProtocol=https;AccountName=${prefix}storage;AccountKey=$($storageKeys[0].value);EndpointSuffix=core.windows.net"
