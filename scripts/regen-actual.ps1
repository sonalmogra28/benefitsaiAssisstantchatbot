...
Write-Host "AZURE_COSMOS_CONNECTION_STRING=AccountEndpoint=https://benefits-chatbot-cosmos-dev.documents.azure.com:443/;AccountKey=$($cosmosKeys.primaryMasterKey)"
...
Write-Host "REDIS_URL=rediss://:$($redisKeys.primaryKey)@${redisHost}:6380"
...
Write-Host "AZURE_STORAGE_CONNECTION_STRING=DefaultEndpointsProtocol=https;AccountName=benefitschatbotdev;AccountKey=$($storageKeys[0].value);EndpointSuffix=core.windows.net"
