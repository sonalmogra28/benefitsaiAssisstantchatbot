        ...
        <TabsContent value="quality" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Average user satisfaction</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-green-600">
                  {data.conversationQuality.averageSatisfaction.toFixed(1)}/5
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-blue-600">
                  {(data.conversationQuality.resolutionRate * 100).toFixed(1)}%
                </div>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold text-orange-600">
                  {(data.conversationQuality.escalationRate * 100).toFixed(1)}%
                </div>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Overall conversation quality</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-purple-600">
                  {data.conversationQuality.qualityScore.toFixed(1)}/10
                </div>
                <p className="text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Conversation quality over time</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-64 flex items-center justify-center text-muted-foreground">
                Quality trend chart would go here
              </div>
            </CardContent>
          </Card>
        </TabsContent>

        {/* Phase 2: Cost Monitoring Tab */}
        <TabsContent value="costs" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader>
                <CardTitle>AI Usage</CardTitle>
                <CardDescription>OpenAI API costs</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">${data.costBreakdown.aiUsage.toFixed(2)}</div>
                <p className="text-sm text-muted-foreground">
                  This month
                </p>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Document storage costs</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">${data.costBreakdown.storage.toFixed(2)}</div>
                <p className="text-sm text-muted-foreground">
                  This month
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">${data.costBreakdown.apiCalls.toFixed(2)}</div>
                <p className="text-sm text-muted-foreground">
                  This month
                </p>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Combined monthly costs</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold text-red-600">${data.costBreakdown.total.toFixed(2)}</div>
                <p className="text-sm text-muted-foreground">
                  Budget: $300/month
                </p>
              </CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Cost threshold notifications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-2 bg-yellow-50 rounded">
                    <span className="text-sm">AI Usage approaching limit</span>
                    <Badge variant="warning">80%</Badge>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-green-50 rounded">
                    <span className="text-sm">Storage within budget</span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-3xl font-bold">
                  {data.performanceMetrics.responseTime}s
                </div>
                <p className="text-sm text-muted-foreground">
                  P95 latency
                </p>
